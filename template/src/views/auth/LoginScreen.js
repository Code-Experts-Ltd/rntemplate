        ...
        <View style={[Style.container, Style.centerJustify]}>
            <View style={Style.hPadding}>
                ...
                <TouchableOpacity onPress={()=>{
                    ...
                    <Text style={[Style.label,Style.colorSecondary]}>Forgot Password</Text>
                </TouchableOpacity>
                <Spacing val={10} />
                {loading && (
                    <>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('Signup')} style={{alignItems:'center'}}>
                    <Text>
                        <Text style={[Style.label,Style.colorPrimary]}>Do not have an account? </Text>
                        <Text style={[Style.label,Style.colorPrimary,Style.fontBold]}>Signup</Text>
                    </Text>
                </TouchableOpacity>
